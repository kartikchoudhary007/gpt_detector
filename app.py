...
if text_area is not None:
    if st.button("Analyze"):
        ...
        with col2:
            ...
            if perplexity > 10000 and burstiness_score < 0.3:
                st.error("Text Analysis Result: Machine generated content")
            else:
                st.success("Text Analysis Result: Likely generated by Human <3")            
